function ris_table = generateIrsLookupTableDestructive(optimal_in_angle, optimal_out_angle, Nr, Nc, fc, r_ap_ue, r_ap_ris, r_ue_ris)
% generateIrsLookupTableDestructive
...
%   r_ue_ap, r_ap_ris, r_ue_ris - distances for the respective paths
    ...
    % Calculate the required phase shift for destructive interference
